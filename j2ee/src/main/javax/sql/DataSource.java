...
/**
 * A DataSource object is a factory for Connection objects. An object that implements the DataSource interface
...
public interface DataSource {
   ...
   *
   * <p>The log writer is a character output stream to which all logging and tracing messages for this data
   ...
   * When a DataSource object is created the log writer is initially null, in other words, logging is disabled.</p>
   *
