...
public class MarshallEndpoint_echoQNameArray_RequestStruct
{

   protected javax.xml.namespace.QName[] arrayOfQName_1;

   public MarshallEndpoint_echoQNameArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoQNameArray_RequestStruct(javax.xml.namespace.QName[] arrayOfQName_1)
   {
