 ...
 */
package org.jboss.test.webservice.jbws632;
 ...
 * @since 21-Jan-2006
 */
public class JBWS632TestCase extends WebserviceTestBase
{
   private static TestSEI port;
   
   public JBWS632TestCase(String name)
   {
      super(name);
   }
   ...
   {
      return getDeploySetup(JBWS632TestCase.class, "ws4ee-jbws632.war, ws4ee-jbws632-client.jar");
   }
