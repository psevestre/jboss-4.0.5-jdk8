...
public class MarshallEndpoint_echoDecimal_RequestStruct
{

   protected java.math.BigDecimal bigDecimal_1;

   public MarshallEndpoint_echoDecimal_RequestStruct()
   {
   }

   public MarshallEndpoint_echoDecimal_RequestStruct(java.math.BigDecimal bigDecimal_1)
   {
