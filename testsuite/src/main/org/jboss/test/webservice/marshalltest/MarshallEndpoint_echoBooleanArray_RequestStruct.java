...
public class MarshallEndpoint_echoBooleanArray_RequestStruct
{

   protected boolean[] arrayOfboolean_1;

   public MarshallEndpoint_echoBooleanArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoBooleanArray_RequestStruct(boolean[] arrayOfboolean_1)
   {
