 ...
 */
package org.jboss.test.webservice.jbws358;
 ...
 * @since 30-Nov-2005
 */
public class JBWS358TestCase extends WebserviceTestBase
{
   public JBWS358TestCase(String name)
   {
      super(name);
   }
