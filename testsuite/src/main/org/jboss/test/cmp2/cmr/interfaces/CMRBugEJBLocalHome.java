 ...
 */
public interface CMRBugEJBLocalHome extends EJBLocalHome
{
   public static final String COMP_NAME="java:comp/env/ejb/CMRBugEJBLocal";
   public static final String JNDI_NAME="LocalReadOnly";

   public CMRBugEJBLocal create(String id , String description , 
         CMRBugEJBLocal parent) throws  CreateException;

   public java.util.Collection findAll() throws  FinderException;

   public  CMRBugEJBLocal findByPrimaryKey(String pk) throws  FinderException; 
}
