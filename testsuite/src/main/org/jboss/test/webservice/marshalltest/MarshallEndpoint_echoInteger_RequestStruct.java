...
public class MarshallEndpoint_echoInteger_RequestStruct
{

   protected java.math.BigInteger bigInteger_1;

   public MarshallEndpoint_echoInteger_RequestStruct()
   {
   }

   public MarshallEndpoint_echoInteger_RequestStruct(java.math.BigInteger bigInteger_1)
   {
