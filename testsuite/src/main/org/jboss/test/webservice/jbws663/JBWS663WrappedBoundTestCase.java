 ...
 * @since 21-Jan-2006
 */
public class JBWS663WrappedBoundTestCase extends WebserviceTestBase
{
   private static SMSTextMessagingSoapWrappedBound port;
   
   public JBWS663WrappedBoundTestCase(String name)
   {
      super(name);
   }
   ...
   {
      return getDeploySetupForJBossWS(JBWS663WrappedBoundTestCase.class, "ws4ee-jbws663wb.war, ws4ee-jbws663wb-client.jar");
   }

   protected void setUp() throws Exception
   {
      super.setUp();
      if (port == null && isJBossWSAvailable())
      {
