 ...
 * @since 09-May-2004
 */
public class MarshallRpcLiteralTestCase extends MarshallTestBase
{
   private static MarshallEndpoint rpclitPort;
   ...
   protected void setUp() throws Exception
   {
      ...
      if (rpclitPort == null)
      {
         ...
         rpclitPort = (MarshallEndpoint)service.getPort(MarshallEndpoint.class);
      }
      port = rpclitPort;
   }
}
