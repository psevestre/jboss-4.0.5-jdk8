   ...
   implements java.io.Serializable
{
   ...
   public DepartmentPK( String departmentCode,String departmentCode2 )
   {
   ...
   public boolean equals(Object obj)
   {
      ...
      {
         if( this.departmentCode == null && (( DepartmentPK)obj).getDepartmentCode() == null )
         {
            eq = true;
         }
         else
         ...
         if( this.departmentCode2 == null && (( DepartmentPK)obj).getDepartmentCode2() == null )
         {
            eq = true;
         }
         else
