...
public class MarshallEndpoint_echoQName_ResponseStruct
{

   protected javax.xml.namespace.QName result;

   public MarshallEndpoint_echoQName_ResponseStruct()
   {
   }

   public MarshallEndpoint_echoQName_ResponseStruct(javax.xml.namespace.QName result)
   {
      this.result = result;
   }
