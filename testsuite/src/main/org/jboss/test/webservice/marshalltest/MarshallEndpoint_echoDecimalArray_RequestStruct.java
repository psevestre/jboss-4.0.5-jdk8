...
public class MarshallEndpoint_echoDecimalArray_RequestStruct
{

   protected java.math.BigDecimal[] arrayOfBigDecimal_1;

   public MarshallEndpoint_echoDecimalArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoDecimalArray_RequestStruct(java.math.BigDecimal[] arrayOfBigDecimal_1)
   {
