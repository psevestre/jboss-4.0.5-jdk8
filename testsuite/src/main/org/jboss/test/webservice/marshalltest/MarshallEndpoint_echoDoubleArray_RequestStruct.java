...
public class MarshallEndpoint_echoDoubleArray_RequestStruct
{

   protected double[] arrayOfdouble_1;

   public MarshallEndpoint_echoDoubleArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoDoubleArray_RequestStruct(double[] arrayOfdouble_1)
   {
