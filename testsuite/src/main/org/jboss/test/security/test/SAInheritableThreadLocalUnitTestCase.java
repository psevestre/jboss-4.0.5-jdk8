...
/**
 * Test that the security context thread locals propagate to child threads
 *
 @author Scott.Stark@jboss.org
 @version $Revision: 57211 $
 */
public class SAInheritableThreadLocalUnitTestCase extends TestCase
{
   private Principal authPrincipal;
   private Subject authSubject;

   public SAInheritableThreadLocalUnitTestCase(String name)
   {
      super(name);
   }
