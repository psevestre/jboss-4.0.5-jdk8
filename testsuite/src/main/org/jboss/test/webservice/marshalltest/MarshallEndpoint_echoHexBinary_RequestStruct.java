...
public class MarshallEndpoint_echoHexBinary_RequestStruct
{

   protected byte[] arrayOfbyte_1;

   public MarshallEndpoint_echoHexBinary_RequestStruct()
   {
   }

   public MarshallEndpoint_echoHexBinary_RequestStruct(byte[] arrayOfbyte_1)
   {
