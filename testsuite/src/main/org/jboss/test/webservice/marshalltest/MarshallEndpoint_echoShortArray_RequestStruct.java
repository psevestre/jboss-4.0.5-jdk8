...
public class MarshallEndpoint_echoShortArray_RequestStruct
{

   protected short[] arrayOfshort_1;

   public MarshallEndpoint_echoShortArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoShortArray_RequestStruct(short[] arrayOfshort_1)
   {
