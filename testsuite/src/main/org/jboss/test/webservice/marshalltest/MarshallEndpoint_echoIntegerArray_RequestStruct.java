...
public class MarshallEndpoint_echoIntegerArray_RequestStruct
{

   protected java.math.BigInteger[] arrayOfBigInteger_1;

   public MarshallEndpoint_echoIntegerArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoIntegerArray_RequestStruct(java.math.BigInteger[] arrayOfBigInteger_1)
   {
