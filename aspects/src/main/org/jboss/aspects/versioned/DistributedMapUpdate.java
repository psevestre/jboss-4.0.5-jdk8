...
public class DistributedMapUpdate implements java.io.Serializable, DistributedUpdate
{
   ...
   public DistributedMapUpdate(GUID guid, HashMap updates, long versionId)
   {
      this.guid = guid;
      this.mapUpdates = updates;
