...
public interface TellerHome extends javax.ejb.EJBHome
{
   ...
   public static final String JNDI_NAME = "Teller";

   public org.jboss.test.jca.bank.interfaces.Teller create() throws javax.ejb.CreateException, java.rmi.RemoteException;
