 ...
 */
public class WorkManagerUnitTestCase extends JBossTestCase
{
   ...
   {
      Test t1 = getDeploySetup(WorkManagerUnitTestCase.class, "jcainflow.rar");
      return t1;
   }

   public void testWorkManager() throws Throwable
   {
      TestResourceAdapterWorkManagerResults results = (TestResourceAdapterWorkManagerResults) getServer().invoke
      (
