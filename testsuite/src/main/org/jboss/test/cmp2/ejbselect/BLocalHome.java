   ...
   extends javax.ejb.EJBLocalHome
{
   ...
   public BLocal create(String id , String name , boolean bool)
      throws javax.ejb.CreateException;

   public BLocal findByPrimaryKey(String pk)
      throws javax.ejb.FinderException;

   public java.util.Collection selectDynamic(String ql,Object[] params) 
   throws javax.ejb.FinderException;
