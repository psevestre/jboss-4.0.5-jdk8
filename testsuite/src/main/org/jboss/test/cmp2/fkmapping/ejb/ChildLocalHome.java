   ...
   extends javax.ejb.EJBLocalHome
{
   ...
   public  ChildLocal create(Long childId , String firstName)
      throws javax.ejb.CreateException;

   public  ChildLocal create(Long childId , String firstName , Long parentId ,
         String parentName)
      throws javax.ejb.CreateException;

   public  ChildLocal findByPrimaryKey(Long pk)
