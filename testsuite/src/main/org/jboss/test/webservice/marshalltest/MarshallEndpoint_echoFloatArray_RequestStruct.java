...
public class MarshallEndpoint_echoFloatArray_RequestStruct
{

   protected float[] arrayOffloat_1;

   public MarshallEndpoint_echoFloatArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoFloatArray_RequestStruct(float[] arrayOffloat_1)
   {
