 ...
 */
public class RecoveryDurableTopicReceiveUnitTestCase extends RecoveryTest
{
   static String RECOVERY_TOPIC = "topic/recoveryDurableTopic";

   Topic recoveryTopic;
   
   public RecoveryDurableTopicReceiveUnitTestCase(String name) throws Exception
   {
      super(name);
   }
