...
public class MarshallEndpoint_echoDateTimeArray_RequestStruct
{

   protected java.util.Calendar[] arrayOfCalendar_1;

   public MarshallEndpoint_echoDateTimeArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoDateTimeArray_RequestStruct(java.util.Calendar[] arrayOfCalendar_1)
   {
