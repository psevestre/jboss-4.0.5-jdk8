 ...
 * @since 13-Jun-2005
 */
public class JBWS168TestCase extends WebserviceTestBase {
	/**
	 * Construct the test case with a given name
	 */
	public JBWS168TestCase(String name) {
		super(name);
	}

	/** Deploy the test */
	public static Test suite() throws Exception {
		return getDeploySetup(JBWS168TestCase.class, "ws4ee-jbws168.war, ws4ee-jbws168-client.jar");
	}
