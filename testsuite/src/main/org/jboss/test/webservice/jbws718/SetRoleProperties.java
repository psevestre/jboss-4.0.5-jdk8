...
public class SetRoleProperties {
    ...
    public SetRoleProperties() {
    }
    
    public SetRoleProperties(java.lang.String name, java.lang.String description, org.jboss.test.webservice.jbws718.ArrayOfTask tasks) {
        this.name = name;
