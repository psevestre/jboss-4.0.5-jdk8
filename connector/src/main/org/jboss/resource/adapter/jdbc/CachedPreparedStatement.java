...
public class CachedPreparedStatement implements PreparedStatement
{
   ...
   public int getResultSetHoldability() throws SQLException
   {
	...
	public void setBlob(int parameterIndex, InputStream inputStream, int length) throws SQLException {
	...
	public void setClob(int parameterIndex, Reader reader, int length) throws SQLException	{
