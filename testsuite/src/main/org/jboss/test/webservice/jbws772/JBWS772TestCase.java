 ...
 */
package org.jboss.test.webservice.jbws772;
 ...
 * @since 24-Mar-2006
 */
public class JBWS772TestCase extends WebserviceTestBase
{
   public JBWS772TestCase(String name)
   {
      super(name);
   }
   ...
   {
      return getDeploySetup(JBWS772TestCase.class, "ws4ee-jbws772.ear");
   }
