 ...
 */
package org.jboss.test.webservice.jbws423;
 ...
 * @since 26-Oct-2005
 */
public class JBWS423TestCase extends WebserviceTestBase
{
   private static DemoEndpoint port;
   
   public JBWS423TestCase(String name)
   {
      super(name);
   }
   ...
   {
      return getDeploySetup(JBWS423TestCase.class, "ws4ee-jbws423.war, ws4ee-jbws423-client.jar");
   }
