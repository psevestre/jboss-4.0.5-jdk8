...
public class MarshallEndpoint_echoByteArray_RequestStruct
{

   protected byte[] arrayOfbyte_1;

   public MarshallEndpoint_echoByteArray_RequestStruct()
   {
   }

   public MarshallEndpoint_echoByteArray_RequestStruct(byte[] arrayOfbyte_1)
   {
