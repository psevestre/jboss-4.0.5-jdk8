...
public final class ByteArrayBlob implements Blob
{
      ...
      throws SQLException
   {
	...
	public InputStream getBinaryStream(long pos, long length) throws SQLException {
      throw new java.sql.SQLFeatureNotSupportedException("[E180] getBinaryStream() is not supported by this driver");		   
	}
	
	public void free() throws SQLException {
      throw new java.sql.SQLFeatureNotSupportedException("[E184] free() is not supported by this driver");
	}
}
