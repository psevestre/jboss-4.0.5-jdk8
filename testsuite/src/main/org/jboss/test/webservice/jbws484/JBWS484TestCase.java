 ...
 * @since 05-Dec-2005
 */
public class JBWS484TestCase extends WebserviceTestBase
{
   private static TestService_PortType endpoint;

   public JBWS484TestCase(String name)
   {
      super(name);
   }
   ...
   {
      return getDeploySetup(JBWS484TestCase.class, "ws4ee-jbws484.war, ws4ee-jbws484-client.jar");
   }
